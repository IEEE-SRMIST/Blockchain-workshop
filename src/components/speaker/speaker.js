  ...
  return (
    <div  id="speaker" className='pt-32 pb-40 lg:h-screen flex flex-col justify-end md:space-x-10 text-lexand md:flex-row'>
        ...
        <div className='text-[#FFFFFF] lg:text-end items-center md:text-center'>
            ...
            <p className='max-w-xl px-10 lg:pr-1 pb-16 text-justify md:pl-10 lg:order-2'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim dffan veniam, quis nostrud  exercitat ullamco laboris nisi ut aliquip argentum.</p>
