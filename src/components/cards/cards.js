...
const Cards = () => {
  ...
  <div className="bg-black">
    <div className="text-Roboto text-2xl lg:text-6xl mb-4 text-white text-center pt-20">
        <h3>Whats in it for you?</h3>
    </div>
    <div>
    <section className="bg-black h-screen flex justify-center items-center gap-x-16 text-white pt-[-10]">
      <div className="w-[300px] h-[380px] bg-transparent cursor-pointer group perspective ">
