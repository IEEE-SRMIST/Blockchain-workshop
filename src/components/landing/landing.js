      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center text-white px-4 lg:px-12 xl:px-24">
        <div className="text-center lg:text-right">
          ...
          <div>
            ...
            Join us for an engaging exploration of blockchain and discover the future of transactions, data storage, and online interactions. Don't miss out on this exciting opportunity to unlock the limitless potential of blockchain!
            </p>
          </div>
        </div>
      </div>
